...
export class ResultsService {
  ...
  async update(id: string, dto: UpdateResultDto) {
    ...
    if (dto.winning_number !== undefined && dto.winning_number !== null) {
      updateData.winning_number = dto.winning_number;
    }
    if (dto.document_url !== undefined) {
      updateData.document_url = dto.document_url;
    }
    ...
    const payload = { ...result, lottery_name: result.lotteries.name };
    this.gateway.emitResultDeclared(payload);
