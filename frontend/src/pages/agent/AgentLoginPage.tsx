    ...
    <div style={{ minHeight: '100vh', background: '#F4F7FE', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{ width: 64, height: 64, borderRadius: 20, background: 'linear-gradient(135deg, #2B73FF 0%, #39B8FF 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', boxShadow: '0 10px 28px rgba(43,115,255,0.3)' }}>
            <span style={{ fontSize: 26, fontWeight: 800, color: '#fff' }}>L</span>
          </div>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#2B3674', letterSpacing: -0.5 }}>LottoAgent</div>
          <div style={{ fontSize: 14, color: '#A3AED0', marginTop: 6, fontWeight: 500 }}>Agent Terminal Login</div>
        </div>
        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '36px 32px', boxShadow: '0 4px 32px rgba(112,144,176,0.15)' }}>
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              background: loading ? '#39B8FF' : 'linear-gradient(135deg, #2B73FF 0%, #39B8FF 100%)',
              border: 'none', borderRadius: 12, color: '#fff',
              fontSize: 15, fontWeight: 700,
              cursor: loading ? 'not-allowed' : 'pointer',
              boxShadow: loading ? 'none' : '0 4px 16px rgba(43,115,255,0.3)',
            }}>
          ...
          <div style={{ textAlign: 'center', marginTop: 24 }}>
            <a href="/admin/login" style={{ fontSize: 13, color: '#A3AED0', textDecoration: 'none', fontWeight: 500 }}>
