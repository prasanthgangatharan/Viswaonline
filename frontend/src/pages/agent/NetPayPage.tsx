...
export function NetPayPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div>
        <div style={{ fontSize: 20, fontWeight: 800, color: '#111827', letterSpacing: -0.3 }}>Net Pay</div>
        <div style={{ fontSize: 13, color: '#6B7280', marginTop: 3, fontWeight: 500 }}>Sales summary per lottery draw</div>
      </div>
